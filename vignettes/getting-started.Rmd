...
```{r, echo=FALSE}
log <- data.frame(
  file = c("script/analysis.R", "script/data-prep.R", "script/visualize.R"),
  commit = c("Initial-Assignment", "abc1234", "def5678"),
  reviewer = c("Jane Doe", "John Smith", "Bob Miller"),
  datetime = c("2024-11-19 10:00:00", "2024-11-19 11:30:00", "2024-11-19 13:00:00")
)
...
datatable(
  ...
  formatStyle(
    'datetime',
    target = 'row',
    backgroundColor = styleEqual("2024-11-19 15:00:00", "#c7e9c0")
  )
```
